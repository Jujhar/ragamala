...
<li class="toclevel-2 tocsection-2"><a href="#Raag_Mala"><span class="toctext">Hover for details</span></a></li>
...
<section style="filter: sepia(0.4);">
  1 🌅 1 ~6 a.m. - 8.24 a.m. <span id="1" style="font-family: 'Fish&Chips'">prata</span>  1   (Day)                 <span>K</span>
